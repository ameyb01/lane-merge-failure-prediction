...
from .handlers import BirdeyeHandler, CameraHandler, CollisionHandler, LidarHandler, MessageHandler, SpectatorHandler, ClosureCameraHandler
...
HANDLER_DICT = {
    ...
    HandlerType.CLOSURE_CAMERA: ClosureCameraHandler,
}
